...
/**
 * Test case for class \GK\Stdapp\Domain\Model\Subscriber.
 *
 * @version $Id$
 ...
 */
class SubscriberTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	/**
	 * @var \GK\Stdapp\Domain\Model\Subscriber
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new \GK\Stdapp\Domain\Model\Subscriber();
	}
